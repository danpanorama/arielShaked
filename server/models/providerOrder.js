...
// הוספת הזמנת ספק חדשה
const insertProviderOrder = (provider_id, provider_name, category, price) => {
  return pool.execute(
    `INSERT INTO provider_orders (provider_id, provider_name, category, price) 
     VALUES (?, ?, ?, ?)`,
    [provider_id, provider_name, category, price]
  );
};
